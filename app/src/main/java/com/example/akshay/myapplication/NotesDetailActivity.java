...
/**
 * An activity representing a single Notes detail screen. This
 * activity is only used narrow width devices. On tablet-size devices,
 * item details are presented side-by-side with a list of items
 * in a {@link NotesListActivity}.
 */
public class NotesDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(NotesDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(NotesDetailFragment.ARG_ITEM_ID));
